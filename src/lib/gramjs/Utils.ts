...
export function strippedPhotoToJpg(stripped: Uint8Array): Uint8Array {
  ...
  return concat(header, stripped.slice(3), JPEG_FOOTER);
}
...
export function getDC(dcId: number, downloadDC = false) {
  ...
  switch (dcId) {
    case 1:
      return {
        id: 1,
        ipAddress: `zws1${downloadDC ? '-1' : ''}.web.imzi.us.kg`,
        port: 443,
      };
    case 2:
      return {
        id: 2,
        ipAddress: `zws2${downloadDC ? '-1' : ''}.web.imzi.us.kg`,
        port: 443,
      };
    case 3:
      return {
        id: 3,
        ipAddress: `zws3${downloadDC ? '-1' : ''}.web.imzi.us.kg`,
        port: 443,
      };
    case 4:
      return {
        id: 4,
        ipAddress: `zws4${downloadDC ? '-1' : ''}.web.imzi.us.kg`,
        port: 443,
      };
    case 5:
      return {
        id: 5,
        ipAddress: `zws5${downloadDC ? '-1' : ''}.web.imzi.us.kg`,
        port: 443,
      };
    default:
